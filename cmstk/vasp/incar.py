...
def algo_tag(value: Any = None) -> Tag:
    return Tag(name="ALGO",
               comment="Determines the electronic minimization algorithm and/or GW calculation type.",
               value=value)

def amin_tag(value: Any = None) -> Tag:
    return Tag(name="AMIN",
               comment="Minimal mixing parameter in Kerker's initial approximation to the charge dielectric function used in the Broyden/Pulay mixing scheme.",
               value=value)

def amix_tag(value: Any = None) -> Tag:
    return Tag(name="AMIX",
...
def bmix_mag_tag(value: Any = None) -> Tag:
    return Tag(name="BMIX_MAG",
               comment="Cutoff wave vector for Kerker mixing scheme for the magnetization density.",
               value=value)
...
def isif_tag(value: Any = None) -> Tag:
    return Tag(name="ISIF",
               comment="Determines whether the stress tensor is calculated and which degrees of freedom are allowed to change.",
               value=value)

def ismear_tag(value: Any = None) -> Tag:
    return Tag(name="ISMEAR",
...
def lreal_tag(value: Any = None) -> Tag:
    return Tag(name="LREAL",
               comment="Determines whether the projection operators are evaluated in real space or reciprocal space.",
               value=value)
