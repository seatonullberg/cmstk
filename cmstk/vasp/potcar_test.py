...
def test_potcar():
    ...
    potcar_FeCr.write("POTCAR_FeCr")
    assert os.path.exists("POTCAR_FeCr")
    double_potcar = PotcarFile("POTCAR_FeCr")
    double_potcar.read()
