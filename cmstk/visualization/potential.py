...
class SetflProfilePlot(object):
    ...
    def make(self):
        ...
        for s in self._setfl.symbols:
            ...
            embedding_x = [self._setfl.d_rho*(i+1) for i in range(self._setfl.n_rho)]
        ...
        for s in self._setfl.symbols:
            ...
            density_x = [self._setfl.d_r*(i+1) for i in range(self._setfl.n_r)]
        ...
        for sp in self._setfl.symbol_pairs:
            ...
            potential_x = [self._setfl.d_r*(i+1) for i in range(self._setfl.n_r)]
