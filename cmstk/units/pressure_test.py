...
def test_pressure_from_area_force():
    """Tests PressureUnit initialization from an instance of an AreaUnit
    and a ForceUnit."""
    value = 1.0
...
def test_bar():
    """Tests initialization and conversion of a Bar object."""
    value = 1.0
    b = Bar(value)
...
def test_pascal():
    """Tests initialization and conversion of a Pascal object."""
    value = 1.0
    p = Pascal(value)
